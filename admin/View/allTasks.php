...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="<?php echo '/admin/create' ?>">Create task</a>
        </div>
...
<div class="container">
    ...
    <!-- Project One -->
    <?php foreach ($allTasks as $k =>$tasks):?>
        <div class="row">
            <div class="col-md-7">
                <a href="#">
                    <img class="img-fluid rounded mb-3 mb-md-0" src="<?php echo "../".$tasks['picture'];?>" alt="" width="320" height="240">
                </a>
            </div>
            <div class="col-md-5">
                <h4>ID <?php echo $tasks['id'];?></h4>
                ...
                <?php endif; ?>
                    ...
                    <a class="btn btn-primary" href="<?php echo '/admin/edit?id='.$tasks['id'] ?>" >Edit</a>
            </div>
        </div>
        <!-- /.row -->
